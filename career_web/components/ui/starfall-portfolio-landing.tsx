  ...
  return (
    <div className="bg-background text-foreground geist-font">
      <div className="relative">
          ...
          <div className="max-w-7xl mx-auto flex justify-between items-center">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="glass-button px-3 py-2 rounded-lg text-foreground text-sm font-medium inter-font flex items-center justify-center"
        ...
        <main
          id="about"
          className="w-full min-h-screen flex flex-col items-center justify-center px-6 py-20 relative overflow-hidden"
        >
